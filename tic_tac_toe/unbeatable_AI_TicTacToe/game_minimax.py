...
from player_minimax import HumanPlayer
from player_minimax import RandomComputerPlayer
from player_minimax import randomClass

class TicTacToe:
    def __init__(self):
        self.board = [' ' for _ in range(9)] #single list to represent 3x3 board
        self.current_winner = None #is there a current winner and if yes, who?
    ...
    def print_board_nums():
        # 0 | 1 | 2 | tells wht number corresponds to what board 
    ...
    def make_move(self, square, letter):
        # if valid move then make a move (assign a letter to square)
    ...
    def winner(self, square, letter):
        # winner if there are 3 in a row
        # check row first:
        row_ind = square // 3
        ...
        # check diagonal
        # check the only diagonal moves (0, 2, 4, 6, 8)
        if square % 2 == 0:
